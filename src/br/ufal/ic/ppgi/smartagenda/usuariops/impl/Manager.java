...
class Manager implements IManager {
	...
	Manager() {
		...
		// add interfaces
		this.providedInterfaces.put("IConsultarusuario", new FacadeConsultarusuario(this));
		this.providedInterfaces.put("IGerenciarusuario", new FacadeGerenciarUsuario(this));
		// TODO 
