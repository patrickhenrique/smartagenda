...
class Manager implements IManager {
	...
	Manager() {
		...
		// add interfaces
		this.providedInterfaces.put("IBaixarExemplar", new FacadeBaixarExemplar(this));
		this.providedInterfaces.put("IConsultarExemplar", new FacadeConsultarExemplar(this));
		this.providedInterfaces.put("IGerenciarExemplar", new FacadeGerenciarExemplar(this));
		// TODO 
